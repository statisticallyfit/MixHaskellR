...
-- |
{-# LINE 2 "src/Foreign/R/Internal.hsc" #-}
...
{-# LINE 16 "src/Foreign/R/Internal.hsc" #-}
...
{-# LINE 42 "src/Foreign/R/Internal.hsc" #-}
import Foreign (Ptr, castPtr, plusPtr, Storable(..))
import Foreign.C
import Prelude hiding (asTypeOf, length)


{-# LINE 47 "src/Foreign/R/Internal.hsc" #-}

{-# LINE 48 "src/Foreign/R/Internal.hsc" #-}

{-# LINE 49 "src/Foreign/R/Internal.hsc" #-}

{-# LINE 50 "src/Foreign/R/Internal.hsc" #-}
...
{-# LINE 67 "src/Foreign/R/Internal.hsc" #-}
           )
...
{-# LINE 145 "src/Foreign/R/Internal.hsc" #-}
...
{-# LINE 149 "src/Foreign/R/Internal.hsc" #-}
...
{-# LINE 153 "src/Foreign/R/Internal.hsc" #-}
