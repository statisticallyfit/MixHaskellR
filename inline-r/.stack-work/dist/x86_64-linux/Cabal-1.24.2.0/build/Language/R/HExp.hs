...
-- |
{-# LINE 2 "src/Language/R/HExp.hsc" #-}
...
{-# LINE 44 "src/Language/R/HExp.hsc" #-}
-- XXX necessary for c2hs.
{-# OPTIONS_GHC -fno-warn-unticked-promoted-constructors #-}

{-# LINE 49 "src/Language/R/HExp.hsc" #-}
...
{-# LINE 86 "src/Language/R/HExp.hsc" #-}

{-# LINE 87 "src/Language/R/HExp.hsc" #-}

{-# LINE 88 "src/Language/R/HExp.hsc" #-}



{-# LINE 91 "src/Language/R/HExp.hsc" #-}
...
{-# LINE 104 "src/Language/R/HExp.hsc" #-}
type role HExp phantom nominal

{-# LINE 106 "src/Language/R/HExp.hsc" #-}
...
{-# LINE 312 "src/Language/R/HExp.hsc" #-}

instance Storable (HExp s a) where
  sizeOf _ = (56)
{-# LINE 315 "src/Language/R/HExp.hsc" #-}
  alignment _ = 8
{-# LINE 316 "src/Language/R/HExp.hsc" #-}
  poke = pokeHExp
...
{-# LINE 361 "src/Language/R/HExp.hsc" #-}
                  <*> (coerceAny <$> R.sexp <$> (\hsc_ptr -> peekByteOff hsc_ptr 40) sptr)
{-# LINE 362 "src/Language/R/HExp.hsc" #-}
      R.Special   -> coerce $
        Special   <$> (fromIntegral <$> ((\hsc_ptr -> peekByteOff hsc_ptr 32) sptr :: IO CInt))
{-# LINE 364 "src/Language/R/HExp.hsc" #-}
      R.Builtin   -> coerce $
        Builtin   <$> (fromIntegral <$> ((\hsc_ptr -> peekByteOff hsc_ptr 32) sptr :: IO CInt))
{-# LINE 366 "src/Language/R/HExp.hsc" #-}
      ...
      R.Vector    -> coerce $
        Vector    <$> (fromIntegral <$> ((\hsc_ptr -> peekByteOff hsc_ptr 36) sptr :: IO CInt))
{-# LINE 375 "src/Language/R/HExp.hsc" #-}
                  <*> pure (Vector.unsafeFromSEXP (unsafeCoerce s))
      R.Expr      -> coerce $
        Expr      <$> (fromIntegral <$> ((\hsc_ptr -> peekByteOff hsc_ptr 36) sptr :: IO CInt))
{-# LINE 378 "src/Language/R/HExp.hsc" #-}
                  <*> pure (Vector.unsafeFromSEXP (unsafeCoerce s))
      R.Bytecode  -> coerce $ return Bytecode
      R.ExtPtr    -> coerce $
        ExtPtr    <$> (castPtr <$> (\hsc_ptr -> peekByteOff hsc_ptr 32) sptr)
{-# LINE 382 "src/Language/R/HExp.hsc" #-}
                  <*> (R.sexp <$> (\hsc_ptr -> peekByteOff hsc_ptr 40) sptr)
{-# LINE 383 "src/Language/R/HExp.hsc" #-}
                  <*> (R.sexp <$> (\hsc_ptr -> peekByteOff hsc_ptr 48) sptr)
{-# LINE 384 "src/Language/R/HExp.hsc" #-}
      ...
      R.S4        -> coerce $
        S4        <$> (R.sexp <$> (\hsc_ptr -> peekByteOff hsc_ptr 48) sptr)
...
pokeHExp s h = do
    case h of
         ...
         Symbol pname value internal -> do
           (\hsc_ptr -> pokeByteOff hsc_ptr 32) s (R.unsexp pname)
{-# LINE 404 "src/Language/R/HExp.hsc" #-}
           (\hsc_ptr -> pokeByteOff hsc_ptr 40) s (R.unsexp value)
{-# LINE 405 "src/Language/R/HExp.hsc" #-}
           (\hsc_ptr -> pokeByteOff hsc_ptr 48) s (R.unsexp internal)
{-# LINE 406 "src/Language/R/HExp.hsc" #-}
         List carval cdrval tagval -> do
           (\hsc_ptr -> pokeByteOff hsc_ptr 32) s (R.unsexp carval)
{-# LINE 408 "src/Language/R/HExp.hsc" #-}
           (\hsc_ptr -> pokeByteOff hsc_ptr 40) s (R.unsexp cdrval)
{-# LINE 409 "src/Language/R/HExp.hsc" #-}
           (\hsc_ptr -> pokeByteOff hsc_ptr 48) s (R.unsexp tagval)
{-# LINE 410 "src/Language/R/HExp.hsc" #-}
         Env frame enclos hashtab -> do
           (\hsc_ptr -> pokeByteOff hsc_ptr 32) s (R.unsexp frame)
{-# LINE 412 "src/Language/R/HExp.hsc" #-}
           (\hsc_ptr -> pokeByteOff hsc_ptr 40) s (R.unsexp enclos)
{-# LINE 413 "src/Language/R/HExp.hsc" #-}
           (\hsc_ptr -> pokeByteOff hsc_ptr 48) s (R.unsexp hashtab)
{-# LINE 414 "src/Language/R/HExp.hsc" #-}
         Closure formals body env -> do
           (\hsc_ptr -> pokeByteOff hsc_ptr 32) s (R.unsexp formals)
{-# LINE 416 "src/Language/R/HExp.hsc" #-}
           (\hsc_ptr -> pokeByteOff hsc_ptr 40) s (R.unsexp body)
{-# LINE 417 "src/Language/R/HExp.hsc" #-}
           (\hsc_ptr -> pokeByteOff hsc_ptr 48) s (R.unsexp env)
{-# LINE 418 "src/Language/R/HExp.hsc" #-}
         Promise value expr env -> do
           (\hsc_ptr -> pokeByteOff hsc_ptr 32) s (R.unsexp value)
{-# LINE 420 "src/Language/R/HExp.hsc" #-}
           (\hsc_ptr -> pokeByteOff hsc_ptr 40) s (R.unsexp expr)
{-# LINE 421 "src/Language/R/HExp.hsc" #-}
           (\hsc_ptr -> pokeByteOff hsc_ptr 48) s (R.unsexp env)
{-# LINE 422 "src/Language/R/HExp.hsc" #-}
         Lang carval cdrval -> do
           (\hsc_ptr -> pokeByteOff hsc_ptr 32) s (R.unsexp carval)
{-# LINE 424 "src/Language/R/HExp.hsc" #-}
           (\hsc_ptr -> pokeByteOff hsc_ptr 40) s (R.unsexp cdrval)
{-# LINE 425 "src/Language/R/HExp.hsc" #-}
         Special offset -> do
           (\hsc_ptr -> pokeByteOff hsc_ptr 32) s (fromIntegral offset :: CInt)
{-# LINE 427 "src/Language/R/HExp.hsc" #-}
         Builtin offset -> do
           (\hsc_ptr -> pokeByteOff hsc_ptr 32) s (fromIntegral offset :: CInt)
{-# LINE 429 "src/Language/R/HExp.hsc" #-}
...
unhexp (List carval cdrval tagval) = acquire <=< io $ do
  ...
  rt <- R.protect tagval
  z  <- R.cons rc rd
  (\hsc_ptr -> pokeByteOff hsc_ptr 48) (R.unsexp z) (R.unsexp rt)
{-# LINE 464 "src/Language/R/HExp.hsc" #-}
  R.unprotect 3
  return z
